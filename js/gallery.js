...
// Генерируем разметку для галереи
...
// Обработка клика по элементам галереи
galleryContainer.addEventListener('click', (event) => {
  ...
  const originalImageUrl = event.target.dataset.source; // Получаем URL оригинального изображения
